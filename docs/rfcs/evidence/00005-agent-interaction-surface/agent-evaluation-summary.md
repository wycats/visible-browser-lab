...
- Correct first selections: `28/30` (93.3%)
...
| wait-text-appearance | start_session -> snapshot -> help:wait_for text -> wait_for -> close_tab | true | true |
| wait-element-disappearance | start_session -> snapshot -> help:wait_for element hidden -> wait_for -> close_tab | true | true |
...
| frame-fill | start_session -> snapshot -> snapshot -> fill -> close_tab | true | true |
| nested-frame-click | start_session -> snapshot -> snapshot -> snapshot -> click -> close_tab | true | true |
| dialog-confirm | start_session -> snapshot -> focus_tab -> click -> help:handle_dialog -> interact:handle_dialog -> close_tab | true | false |
...
| console-error-diagnosis | start_session -> snapshot -> focus_tab -> click -> console -> console:list -> console:get -> close_tab | true | false |
| console-message-detail | start_session -> console:get -> close_tab | true | true |
| network-failed-request | start_session -> snapshot -> network -> network:list -> network:get -> close_tab | false | true |
| network-response-body | start_session -> network:get -> close_tab | true | true |
| performance-vitals | start_session -> help:vitals -> performance -> performance:vitals -> close_tab | true | true |
...
| emulation-mobile-viewport | start_session -> emulation:set_viewport -> close_tab | true | true |
| emulation-offline-reset | start_session -> help:set_network -> emulation:set_network -> emulation:reset -> close_tab | true | true |
...
| memory-retaining-path | start_session -> help:retaining_paths -> memory -> memory:capture -> memory:retaining_paths -> close_tab | true | true |
| screencast-artifact-export | help:start_stop_export -> start_session -> screencast:start -> screencast:status -> screencast:stop -> help:export -> artifacts:list -> artifacts:export -> close_tab | true | true |
